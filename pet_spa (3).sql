...
INSERT INTO `pet_tags` (`id`, `created_at`, `deleted`, `updated_at`, `description`, `icon_url`, `name`) VALUES
(1, '2024-10-03 09:29:11.339685', b'0', '2024-10-03 09:29:11.339685', 'Chicken thigh tag', 'http://localhost:8090/uploads/pet-tags/1727922551319-61bch1ooiml-ac-sl1200.jpg', 'Chicken thigh tag'),
(2, '2024-10-03 09:29:48.645392', b'0', '2024-10-03 09:29:48.645392', 'Fishbone tag', 'http://localhost:8090/uploads/pet-tags/1727922588635-61rzlxunxal-ac-sl1200.jpg', 'Fishbone tag'),
(3, '2024-10-03 09:30:40.217370', b'0', '2024-10-03 09:30:40.217370', 'Bone tag', 'http://localhost:8090/uploads/pet-tags/1727922640212-61ubnp8d3el-ac-sl1200.jpg', 'Bone tag'),
(4, '2024-10-03 09:31:53.239254', b'0', '2024-10-03 09:31:53.239254', 'Paw tag', 'http://localhost:8090/uploads/pet-tags/1727922713232-61bdf51cbdl-ac-sl1200.jpg', 'Paw tag');
...
(12, '2024-10-03 07:40:25.681115', b'0', '2024-10-03 07:40:25.681115', '2024-10-02 17:00:00.000000', NULL, '', 'payment-at-store', 'Self-drop-off', 'Self-drop-off', '40.00', NULL, 'Self-return', 'Self-return', 'Pending', '2024-10-02 17:00:00.000000', '7:40 AM', 6, 27, 2);
...
(1, NULL, b'0', NULL, 'Comprehensive care for your pet\'s fur, ensuring it stays clean, healthy, and stylish', 'Grooming', 'https://via.placeholder.com/500?text=Grooming'),
(2, NULL, b'0', NULL, 'Specialized treatments to keep your pet\'s skin in top condition, addressing common skin issues and improving comfort.', 'Skincare', 'https://via.placeholder.com/500?text=Skincare'),
(3, NULL, b'0', NULL, ': Focused care for paws and nails to keep them clean, healthy, and free of discomfort.', 'Pawdicure', 'https://via.placeholder.com/500?text=Pawdicure'),
(4, NULL, b'0', NULL, 'Essential dental services to maintain your pet\'s oral hygiene and prevent common issues like bad breath or gum disease.', 'Oral Care', 'https://via.placeholder.com/500?text=Oral+Care'),
(5, NULL, b'0', NULL, 'Soothing massages designed to relieve stress, improve circulation, and address specific health concerns.', 'Massage Therapy', 'https://via.placeholder.com/500?text=Massage+Therapy'),
(6, NULL, b'0', NULL, 'Artistic grooming services that give your pet a unique look and personality.', 'Pet Styling', 'https://via.placeholder.com/500?text=Pet+Styling'),
(7, NULL, b'0', NULL, 'Calming therapies that combine aromatherapy, herbal treatments, and deep cleansing baths to help your pet relax.', 'Relaxation', 'https://via.placeholder.com/500?text=Relaxation');
...
(1, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Bath+Coat+Conditioning', 'Bath & Coat Conditioning', '30.00', 1, 'Cleanse, massage, and condition pet\'s coat for smooth and shiny fur.'),
(2, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Haircut+Trimming', 'Haircut & Trimming', '40.00', 1, 'Trim and style pet\'s fur to keep it neat and tidy.'),
(3, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Special+Coat+Care', 'Special Coat Care', '50.00', 1, 'Detangle and groom for long or easily matted coats.'),
(4, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Herbal+Bath', 'Herbal Bath', '35.00', 2, 'Soothe skin with natural herbs to reduce itching and irritation.'),
(5, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Moisturizing+Treatment', 'Moisturizing Treatment', '30.00', 2, 'Hydrate dry skin, leaving it soft and healthy.'),
(6, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Flea+Tick+Treatment', 'Flea & Tick Treatment', '25.00', 2, 'Eliminate fleas and ticks with safe, effective products.'),
(7, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Nail+Trimming', 'Nail Trimming', '15.00', 3, 'Gentle nail trimming to avoid discomfort or injury.'),
(8, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Paw+Nail+Care', 'Paw & Nail Care', '20.00', 3, 'Moisturize and protect paws from dryness or cracking.'),
(9, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Paw+Cleaning+Deodorizing', 'Paw Cleaning & Deodorizing', '10.00', 3, 'Clean and remove odors from paws.'),
(10, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Tooth+Brushing', 'Tooth Brushing', '20.00', 4, 'Clean pet’s teeth to prevent plaque and bad breath.'),
(11, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Plaque+Removal', 'Plaque Removal', '40.00', 4, 'Remove plaque buildup and improve oral hygiene.'),
(12, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Breath+Freshening', 'Breath Freshening', '15.00', 4, 'Keep your pet’s breath fresh with safe oral care.'),
(13, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Relaxation+Massage', 'Relaxation Massage', '45.00', 5, 'Relieve muscle tension and improve blood circulation.'),
(14, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Therapeutic+Massage', 'Therapeutic Massage', '50.00', 5, 'Alleviate pain for older pets or those with joint issues.'),
(15, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Stress+Relief+Massage', 'Stress Relief Massage', '40.00', 5, 'Calm anxious pets with a soothing massage.'),
(16, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Artistic+Fur+Styling', 'Artistic Fur Styling', '60.00', 6, 'Create unique and stylish looks for your pet.'),
(17, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Safe+Fur+Coloring', 'Safe Fur Coloring', '50.00', 6, 'Apply safe, allergy-free pet dye for a fashionable look.'),
(18, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Light+Makeup', 'Light Makeup', '25.00', 6, 'Add subtle, cute accents for special occasions.'),
(19, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Aromatherapy', 'Aromatherapy', '30.00', 7, 'Use safe essential oils to relax and calm your pet.'),
(20, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Herbal+Steam+Bath', 'Herbal Steam Bath', '35.00', 7, 'Deep cleanse with herbal steam for skin and coat.'),
(21, NULL, b'0', NULL, 'https://via.placeholder.com/500?text=Mineral+Mud+Bath', 'Mineral Mud Bath', '40.00', 7, 'Detoxify and deeply cleanse your pet\'s coat and skin.');
